    ...
    <main class="max-w-7xl mx-auto ">
        ...
        <section class="flex flex-col-reverse justify-center sm:flex-row p-6 items-center gap-4 mb-12">
            <article class="sm:w-1/2 ">
                ...
                <form action="{{ url('/searchproducts') }}" class="animate-reveal">
        ...
        <div class="flex flex-col-reverse justify-center sm-flex-row  items-center mt-10 md:mt-0">
            <a href="#food"
        ...
        <hr class="mx-auto bg-orange-900 w-1/2 h-1 mt-20" id="food">
        ...
        <section class="p-6 my-1 justify-center items-center">
            ...
            <ul class="list-none mx-auto my-12 flex flex-col sm:flex-row items-center gap-8">
                ...
                <li class=" w-full sm:w-5/6 flex flex-col items-center bg-white py-6 rounded-3xl shadow-2xl">
                    ...
                    <p class="font-['Poppins'] text-gray-600 text-xl mt-3 mx-2 text-center hidden "
                        id="product-desc-1">
                        The
